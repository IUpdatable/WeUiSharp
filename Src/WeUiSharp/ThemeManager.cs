    ...
    public class ThemeManager : DependencyObject
    {
        ...
        private static readonly DependencyPropertyKey ActualApplicationThemePropertyKey =
            DependencyProperty.RegisterReadOnly(
                ...
                typeof(ApplicationTheme),
                typeof(ThemeManager),
                new PropertyMetadata(WeUiSharp.ApplicationTheme.Light, OnActualApplicationThemeChanged));
        ...
        private static void OnActualApplicationThemeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            switch (newValue)
            {
                case WeUiSharp.ApplicationTheme.Light:
                    tm._defaultActualTheme = ElementTheme.Light;
                    break;
                case WeUiSharp.ApplicationTheme.Dark:
        ...
        private void UpdateActualApplicationTheme()
        {
            ...
            {
                ActualApplicationTheme = ApplicationTheme ?? WeUiSharp.ApplicationTheme.Light;
            }
        }
        ...
        private static readonly DependencyProperty InheritedApplicationThemeProperty =
            DependencyProperty.RegisterAttached(
                ...
                typeof(ApplicationTheme),
                typeof(ThemeManager),
                new PropertyMetadata(WeUiSharp.ApplicationTheme.Light, OnInheritedApplicationThemeChanged));
        ...
        internal bool UsingSystemTheme => ApplicationTheme == null;
        ...
        {
            return ColorsHelper.Current.SystemTheme.GetValueOrDefault(WeUiSharp.ApplicationTheme.Light);
        }
